...
class NewsStory(object):
    ...
    def getGuid(self): return self.guid
...
class PhraseTrigger(Trigger):
    def __init__(self, phrase):
        self.phrase = phrase
    def evaluate(self, story):
        a = self.phrase in story.getSubject()
        b = self.phrase in story.getTitle()
        c = self.phrase in story.getSummary()
        return (a or b or c)
